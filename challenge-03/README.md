...
*/
pessoa.nomeCompleto(); //Olá! Meu nome é Valter Santos!
...
*/
pessoa.caminhouQuantosMetros; // 1.500
...
// Agora, apresente-se ;)
pessoa.apresentacao(); // Olá, eu sou o Valter Santos, tenho 18 anos, 1.80, meu peso é 90 e, só hoje, eu já caminhei 1.500 metros!
```
